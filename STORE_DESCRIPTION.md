...
This is the marketing copy submitted in the Chrome Web Store listing. Edit here; copy to the submission form.
...
- This is a browser-only block. It does not affect AI desktop apps, AI features inside other apps (Gmail Smart Compose, Notion AI), or AI in your terminal.
- Blocks only the chat-tool websites you configure, not embedded AI features on arbitrary sites.